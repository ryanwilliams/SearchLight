...
Your script "do_search.php" must return some JSON structured like this example (indentation and whitespace is optional. Also the 'More' category is optional):
...
<pre><code>[
    ...
    { 'title': 'More', 'results': [ 
        ['/link_to_full_search', '168 more search results', '']
    ]}
]</code></pre>
